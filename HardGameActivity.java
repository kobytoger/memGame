...
public class HardGameActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timer_view = findViewById(R.id.hard_timer);
        startTimer();
        ...
        GridLayout gridLayout = findViewById(R.id.grid_layout_hard);
        ...
        buttonGraphics[8] = R.drawable.pic_4;
        buttonGraphics[9] = R.drawable.pic_5;
